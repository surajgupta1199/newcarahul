...
public $column_order = array(null, 'course_id','course_title','course_status'); //set column field database for datatable orderable
	...
	public function get_part_detail_course($where,$table){
		$course_type =	$this->db->select('course_price_master.*,atr1.course_type_value_name as course_validity,atr2.value as mode,atr3.value as value')
						    	 ->where($where)
						    	 ...
						    	 ->join('attribute_value_master as atr3', 'atr3.value_id = course_price_master.course_view')
