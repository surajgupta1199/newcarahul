...
class Student_model extends CI_Model{
	...
	public function get_min_prod_price($where_price,$table){
      $query = $this->db->query('SELECT * FROM '.$table.' WHERE course_id = '.$where_price["course_id"].' AND course_discount_price =   ( SELECT MIN(course_discount_price) FROM '.$table.' WHERE course_id = '.$where_price["course_id"].' GROUP BY course_id) ');
