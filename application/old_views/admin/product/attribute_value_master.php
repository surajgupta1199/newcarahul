...
$('#add_cat_form').submit(function(e){    
      ...
      if($('#attr_type_id').val() == 4){
          ...
          if(check_validity_value != true){
              console.log(check_validity_value);
      ...
      $.ajax({  
          ...
          { 
              ...
              if(result.msg == "success"){        
                  ...
                  $('#fp_response').html("<br><div class='alert alert-danger col-md-12'> <div class='container col-md-12'></button> <b>Content Name Already Exists.</b></div></div>");
