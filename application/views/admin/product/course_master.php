...
<script type="text/javascript">
    ...
    function edit_course(course_id) {
        ...
        $.ajax({
            ...
            {  
                ...
                $('#edit_course_googledrive_link').val(result.course_googledrive_link);
    ...
    $(".validation-wizard").steps({
        ...
        , onStepChanging: function (event, currentIndex, newIndex) {
            ...
            var course_amount = $('.course_amount');
            var course_amount_greater_0 = 0;
            for(var i =0;i< course_amount.length;i++){
                if($(course_amount[i]).val() != "" || $(course_amount[i]).val() > 0 ){
                    course_amount_greater_0++;
                }
            }
            if(course_amount_greater_0 == 0){
            ...
            $.ajax({  
                ...
                success:function(result)  
                {
                    if(result.type == "success"){ 
                        ...
                        alert('info',result.message,'error');
                    }
                    return false;
    ...
    $(".validation-wizard-edit").steps({
        ...
        , onFinishing: function (event, currentIndex) {
            ...
            form.append('other_info',other_info);
            ...
            $.ajax({  
                ...
                { 
                    if(result.type == "success"){ 
                        ...
                        table.ajax.reload();
                        swal('info',"Course Updated Successfully",'success') ;     
                    }else{
                         alert('info',result.message,'error');
                    }
                    return false;
