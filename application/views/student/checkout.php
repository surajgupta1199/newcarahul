      ...
      <div class="row">
        ...
        <div class="col-md-8 order-md-1 bg-white rounded shadow-sm">
          ...
          <form class="needs-validation" id="update_checkout_detail" novalidate>
              <br>
              <div class="text-center"><span class="red-star">* </span>all fields are required</div>
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <label for="lastName"><span class="red-star">* </span>Mother name</label>
                ...
                <div class="col-md-6 mb-3">
                  <label for="lastName"><span class="red-star">* </span>Father name</label>
                ...
                <div class="col-md-6 mb-3">
                  <label for="lastName"><span class="red-star">* </span>Mobile number</label>
                ...
                <div class="col-md-6 mb-3">
                  <label for="student_phone_option"><span class="red-star">* </span>Alternate mobile number </label>
                ...
                <div class="col-md-6 mb-3">
                  <label for="lastName"><span class="red-star">* </span>Email</label>
                ...
                <div class="col-md-6 mb-3">
                  <label for="lastName"><span class="red-star">* </span>ICAI Registeration </label>
                ...
                <div class="col-md-6 mb-3">
                <label for="lastName"><span class="red-star">* </span>Attempt Due Month</label>
                <?php $readonly_status= $student_details['student_bil_attempt_due_month'] != '' ? 'disabled':''; ?>
                  <select name="student_bil_attempt_due_month" id="student_bil_attempt_due_month" <?php echo $readonly_status; ?> class="form-control " data-required="1" data-placeholder="">
                      <option value="1" <?php if($student_details['student_bil_attempt_due_month'] == "1"){echo 'selected';} ?> >January</option>
                      <option value="2" <?php if($student_details['student_bil_attempt_due_month'] == "2"){echo 'selected';} ?> >February</option>
                      <option value="3" <?php if($student_details['student_bil_attempt_due_month'] == "3"){echo 'selected';} ?> >March</option>
                      <option value="4" <?php if($student_details['student_bil_attempt_due_month'] == "4"){echo 'selected';} ?> >April</option>
                      <option value="5" <?php if($student_details['student_bil_attempt_due_month'] == "5"){echo 'selected';} ?> >May</option>
                      <option value="6" <?php if($student_details['student_bil_attempt_due_month'] == "6"){echo 'selected';} ?> >June</option>
                      <option value="7" <?php if($student_details['student_bil_attempt_due_month'] == "7"){echo 'selected';} ?> >July</option>
                      <option value="8" <?php if($student_details['student_bil_attempt_due_month'] == "8"){echo 'selected';} ?> >August</option>
                      <option value="9" <?php if($student_details['student_bil_attempt_due_month'] == "9"){echo 'selected';} ?> >September</option>
                      <option value="10"<?php if($student_details['student_bil_attempt_due_month'] == "10"){echo 'selected';} ?> >October</option>
                      <option value="11"<?php if($student_details['student_bil_attempt_due_month'] == "11"){echo 'selected';} ?> >November</option>
                      <option value="12"<?php if($student_details['student_bil_attempt_due_month'] == "12"){echo 'selected';} ?> >December</option>
                  </select>
                  <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                <label for="lastName"><span class="red-star">* </span>Attempt Due Year</label>
                <?php $readonly_status= $student_details['student_bil_attempt_due_year'] != '' ? 'disabled':'';?>
                  <select name="student_bil_attempt_due_year" id="student_bil_attempt_due_year" <?php echo $readonly_status; ?> class="form-control " data-required="1" data-placeholder="">
                      <?php 
                        for($i=2021;$i<=2050;$i++){
                            $select_option = $student_details['student_bil_attempt_due_year'] == $i ? "selected" : "";
                            echo '<option value='.$i.' '.$select_option.'>'.$i.'</option>';
                        }
                  ...
                  <?php 
                    $registration_proof = $student_details['student_bil_ICAI_proof'] =='' ? '<div class="form-group col-md-6"><label class="mb-0"><span class="red-star">* </span>Registration Proof (Registration Form, Roll No., Marksheet)</label>
                    ...
                    $government_proof_front = $student_details['student_bil_government_front'] =='' ? '<div class="form-group col-md-6"><label class="mb-0"><span class="red-star">* </span>Government Proof Front (Adhaar ID/ Voter ID/ Driving Licence) Front</label>
                    ...
                    $government_proof_back = $student_details['student_bil_government_back'] =='' ? '<div class="form-group col-md-6"><label class="mb-0"><span class="red-star">* </span>Government Proof Back (Adhaar ID/ Voter ID/ Driving Licence) Back</label>
              ...
              <div class="mb-3">
                <label for="address"><span class="red-star">* </span>Address <span><small><a href="<?php echo base_url(); ?>student" class="edit-links"><i class="fa fa-edit"></i> (Change Shipping Address)</a></small></span></label>
              ...
              <div class="mb-3">
                <label for="address2"><span class="red-star">* </span>Address Line 2</label>
              ...
              <div class="row">
                <div class="col-md-4 mb-3">
                  <label for="country"><span class="red-star">* </span>City</label>
                ...
                <div class="col-md-4 mb-3">
                  <label for="state"><span class="red-star">* </span>State</label>
                ...
                <div class="col-md-4 mb-3">
                  <label for="state"><span class="red-star">* </span>State Code</label>
                  <?php $readonly_status= $student_details['stu_bil_state_code'] != '' ? 'disabled':''; ?>
                  <select name="stu_bil_state_code" id="stu_bil_state_code" <?php echo $readonly_status; ?> class="form-control " data-required="1" data-placeholder="">
                      <?php  
                        foreach ($state_code as $row) {?>
                            <option <?php if($student_details['stu_bil_state_code'] == $row['state_code_id']){echo 'selected';} ?> value="<?php echo $row['state_code_id']; ?>" ><?php echo $row['state_code']; ?></option>
                        <?php }?>
                  </select>
                  <div class="invalid-feedback">
                    Please provide a valid state.
                ...
                <div class="col-md-6 mb-3">
                  <label for="zip"><span class="red-star">* </span>Pincode</label>
