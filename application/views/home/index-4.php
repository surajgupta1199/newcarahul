...
<header class="header_wrap dark_skin">
	<div class="top-header light_skin bg_blue2 border-0">
        <div class="container">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg"> 
            ...
            <ul class="navbar-nav attr-nav align-items-center">
                <li><a href="#" class="btn btn-default btn-sm btn-radius">Apply Now</a></li>
            </ul>
        </nav>
    </div>
</header>
...
<section class="banner_section parallax_bg overlay_bg_blue_80" data-parallax-speed="0.7" data-parallax-bg-position="top center" data-parallax-bg-image="assets/images/banner11.jpg">
    <div class="container"><!-- STRART CONTAINER -->
        <div class="row">
            <div class="col-12">
                <div class="text-center animation" data-animation="fadeInLeft" data-animation-delay="0.02s">
                    <div class="heading_s1 heading_light">
                        <h2>Learn Anything, anywhare</h2>
                    </div>
                    <p class="text-white">If you are going to use a passage of Lorem Ipsum, you need to be sure there<br class="d-none d-md-block"> isn't anything embarrassing hidden in the middle of text</p>
                    <form method="post" name="enq" class="pt-md-2 form_style3 form-row justify-content-center">
                            <div class="form-group col-lg-3 col-md-4">
                                <input required="required" placeholder="Search..." class="form-control" name="name" type="text">
                             </div>
                            <div class="form-group col-lg-3 col-md-4">
                            ...
                            <div class="col-auto">
                                <button type="submit" title="Submit Your Message!" class="btn btn-default btn-radius" name="submit" value="Submit">Search Course</button>
                            </div>
                    </form>                        
                </div>
            </div>
        	...
        	<div class="col-xl-6 col-lg-8">
            	<div class="text-center animation" data-animation="fadeInUp" data-animation-delay="0.01s">
                    <div class="heading_s1 text-center">
                        <h2>Most Popular Top Categories</h2>
                    </div>
...
<section class="bg_gray">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="icon_box text-center bg-white icon_box_style2 box_shadow2 radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                	<div class="box_icon bg_light_navy mb-3">
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="icon_box text-center bg-white icon_box_style2 box_shadow2 radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.03s">
                	<div class="box_icon bg_blue2 mb-3">
                        <img src="assets/images/scholarship.png" alt="scholarship" />
                    </div>
                    <div class="intro_desc">
                        <h5>Scholarship</h5>
                        <p>If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text</p>
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="icon_box text-center bg-white icon_box_style2 box_shadow2 radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.04s">
                	<div class="box_icon bg_pink mb-3">
	...
	<div class="container">
        ...
        <div class="row">
        	<div class="col-lg-4 col-sm-6">
            	<div class="content_box hover_style1 radius_all_10 box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
            ...
            <div class="col-lg-4 col-sm-6">
            	<div class="content_box hover_style1 radius_all_10 box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.03s">
                	<div class="content_img radius_ltrt_10">
            ...
            <div class="col-lg-4 col-sm-6">
            	<div class="content_box hover_style1 radius_all_10 box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.04s">
                	<div class="content_img radius_ltrt_10">
        ...
        <div class="row">
        	<div class="col-12">
            	<div class="text-center animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                	...
                	<a href="#" class="btn btn-default btn-radius">View All Courses <i class="ion-ios-arrow-thin-right ml-1"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="background_bg bg_blue2 bg_fixed" data-img-src="assets/images/pattern_bg4.png">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-6 ">
                <div class="box_counter counter_style2 text_white text-center animation" data-animation="fadeInUp" data-animation-delay="0.05s">
                	<div class="counter_icon">
...
<section>
	<div class="container">
        ...
        <div class="row justify-content-center">
        	<div class="col-lg-4 col-sm-6">
            	<div class="content_box hover_style1 event_box radius_all_10 box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                	<div class="content_img radius_ltrt_10">
                    ...
                    <div class="content_desc">
                    	<h4 class="content_title"><a href="#">Nullam id varius nunc id varius nunc</a></h4>
                        <ul class="list_none content_meta border-0 pb-0 mb-0">
            ...
            <div class="col-lg-4 col-sm-6">
            	<div class="content_box hover_style1 event_box radius_all_10 box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.03s">
                	<div class="content_img radius_ltrt_10">
            ...
            <div class="col-lg-4 col-sm-6">
            	<div class="content_box hover_style1 event_box radius_all_10 box_shadow1 animation" data-animation="fadeInUp" data-animation-delay="0.04s">
                	<div class="content_img radius_ltrt_10">
...
<section class="background_bg overlay_bg_blue2_80 bg_fixed" data-img-src="assets/images/cta_bg.jpg">
	<div class="container">
    	<div class="row align-items-center">
        	<div class="col-md-8">
            	<div class="text_white cta_section animation" data-animation="fadeInUp" data-animation-delay="0.01s">
                    <div class="heading_s1 heading_light">
            ...
            <div class="col-md-4">
            	<div class="text-md-right animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                    <a href="#" class="btn btn-outline-white btn-radius">Get Started</a>
                </div>
            </div>
        </div>
    </div>
...
<section>
	<div class="container">	
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="team_box team_style3 animation" data-animation="fadeInUp" data-animation-delay="0.03s">
                	<div class="team_img">
            ...
            <div class="col-lg-3 col-sm-6">
            	<div class="team_box team_style3 animation" data-animation="fadeInUp" data-animation-delay="0.05s">
                	<div class="team_img">
...
<section class="p-0 overflow_hide">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 p-0 animation" data-animation="fadeInUp" data-animation-delay="0.02s"> 
                <div class="h-100 background_bg overlay_bg_50 md-height-300" data-img-src="assets/images/about_img.jpg">
                	<a href="https://www.youtube.com/watch?v=7e90gBu4pas" class="video_popup video_play"><img class="bounce_img" src="assets/images/play-icon.png" alt="play-icon"/></a>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 p-0 animation" data-animation="fadeInUp" data-animation-delay="0.03s">
            	<div class="bg_blue2 h-100 d-flex align-items-center padding_eight_all text_white">
                	<div>
                        <div class="heading_s1 heading_light"> 
                        ...
                        <ul class="list_style_1">
                        	<li>If you are going to use of anything embarrassing in the middle of text</li>
    	...
    	<div class="row align-items-center">
        	<div class="col-lg-6">
                <div class="animation" data-animation="fadeInUp" data-animation-delay="0.01s">
                    ...
                    <div class="testimonial_slider testimonial_style4 carousel_slider owl-carousel owl-theme nav_bottom_right pr-lg-4 animation" data-margin="30" data-loop="true" data-autoplay="true" data-dots="false" data-nav="true" data-autoheight="true" data-animation="fadeInLeft" data-animation-delay="0.02s" data-items="1">
                        <div class="testimonial_box">
                            ...
                            <div class="testimonial_img">
                                <img class="radius_all_5" src="assets/images/user1.jpg" alt="user1">
                            </div>
                        ...
                        <div class="testimonial_box">
                            ...
                            <div class="testimonial_img">
                                <img class="radius_all_5" src="assets/images/user2.jpg" alt="user2">
                            </div>
                            <div class="testi_user">
                                <h6>Lissa Castro</h6>
                                <span class="text_default">Co-Founder</span>
                        ...
                        <div class="testimonial_box">
                            ...
                            <div class="testimonial_img">
                                <img class="radius_all_5" src="assets/images/user3.jpg" alt="user3">
                            </div>
                            <div class="testi_user">
                                <h6>Lissa Castro</h6>
                                <span class="text_default">Co-Founder</span>
            ...
            <div class="col-lg-6 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
            	<div class="testi_img_holder">
                    <div class="testimonial_shape"><img src="assets/images/testimonial_shape.png" alt="testimonial_shape"/></div>
                    <div class="background_bg testimonial_image" data-img-src="assets/images/testimonial_img.jpg"></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="bg_gray">
	<div class="container">
        ...
        <div class="row justify-content-center">
        	<div class="col-lg-4 col-md-6">
            	<div class="blog_post box_shadow1 radius_all_10 blog_hover_style1 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="blog_post box_shadow1 radius_all_10 blog_hover_style1 animation" data-animation="fadeInUp" data-animation-delay="0.03s">
                	<div class="blog_img radius_ltrt_10">
                        <a href="#">
        ...
        <div class="row">
        	<div class="col-12">
            	<div class="text-center animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                	<div class="medium_divider"></div>
                	<a href="#" class="btn btn-default btn-radius">View All Blog <i class="ion-ios-arrow-thin-right ml-1"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<section>
	<div class="container">
    	...
    	<div class="row">
        	<div class="col-md-12 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
...
<!-- START FOOTER -->
<footer class="footer_dark background_bg bg_blue2 bg_fixed" data-img-src="assets/images/pattern_bg4.png">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="newsletter_form rounded_input mb-4">
                        <form> 
                            <input type="text" class="form-control" required="" placeholder="Email Address">
                            <button type="submit" title="Subscribe" class="btn btn-default btn-sm btn-radius" name="submit" value="Submit">Subscribe</button>
                        </form>
                    </div>
                    <h6 class="widget_title">Follow Us</h6>
                    <ul class="list_none social_icons rounded_social social_white border_social">
                    	<li><a href="#"><i class="ion-social-facebook"></i></a></li>
                        <li><a href="#"><i class="ion-social-twitter"></i></a></li>
                        <li><a href="#"><i class="ion-social-googleplus"></i></a></li>
                        <li><a href="#"><i class="ion-social-youtube-outline"></i></a></li>
    ...
    <div class="bottom_footer border_top_tran">
    	<div class="container">
        	<div class="row align-items-center">
            	<div class="col-md-6">
                	<p class="copyright m-md-0 text-center text-md-left">© 2018 All Rights Reserved by CA Rahul Garg.</p>
                </div>
                <div class="col-md-6">
