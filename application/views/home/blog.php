        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="blog_post box_shadow1 radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.03s">
                	<div class="blog_img radius_ltrt_10">
                        <a href="#">
                            <img src="<?php echo base_url(); ?>assets/images/blog_small_img3.jpg" alt="blog_small_img3">
                            <div class="link_blog">
                            	<span class="ripple"><i class="fa fa-link"></i></span>
                            </div>
                        </a>
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="blog_post box_shadow1 radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.04s">
                	<div class="blog_img radius_ltrt_10">
                        <a href="#">
                            <img src="<?php echo base_url(); ?>assets/images/blog_small_img4.jpg" alt="blog_small_img4">
                            <div class="link_blog">
                            	<span class="ripple"><i class="fa fa-link"></i></span>
                            </div>
                        </a>
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="blog_post box_shadow1 radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.05s">
                	<div class="blog_img radius_ltrt_10">
                        <a href="#">
                            <img src="<?php echo base_url(); ?>assets/images/blog_small_img5.jpg" alt="blog_small_img5">
                            <div class="link_blog">
                            	<span class="ripple"><i class="fa fa-link"></i></span>
                            </div>
                        </a>
            ...
            <div class="col-lg-4 col-md-6">
            	<div class="blog_post box_shadow1 radius_all_10 animation" data-animation="fadeInUp" data-animation-delay="0.06s">
                	<div class="blog_img radius_ltrt_10">
                        <a href="#">
                            <img src="<?php echo base_url(); ?>assets/images/blog_small_img6.jpg" alt="blog_small_img6">
                            <div class="link_blog">
                            	<span class="ripple"><i class="fa fa-link"></i></span>
                            </div>
                        </a>
