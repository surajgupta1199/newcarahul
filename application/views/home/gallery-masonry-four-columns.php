...
<!-- SITE TITLE -->
<title>Gallery | CA Rahul Garg - Education & Courses</title>
<!-- Favicon Icon -->
                ...
                <ul class="navbar-nav">
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul> 
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>home/index">Home Version 1</a></li> 
                                <li><a class="dropdown-item nav-link nav_item" href="index-<?php echo base_url(); ?>home/2">Home Version 2</a></li>
                                <li><a class="dropdown-item nav-link nav_item" href="index-<?php echo base_url(); ?>home/3">Home Version 3</a></li>
                                <li><a class="dropdown-item nav-link nav_item" href="index-<?php echo base_url(); ?>home/4">Home Version 4</a></li>
                                <li><a class="dropdown-item nav-link nav_item" href="index-<?php echo base_url(); ?>home/5">Home Version 5</a></li>
                                <li><a class="dropdown-item nav-link nav_item" href="index-<?php echo base_url(); ?>home/6">Home Version 6</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul> 
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>home/about">About Us</a></li> 
                                <li class="dropdown">
                                    <a class="dropdown-item menu-link dropdown-toggler active" href="#">Gallery</a>
                                    <div class="dropdown-menu">
                                        <ul> 
                                            <li><a class="dropdown-item nav-link nav_item" href="gallery-three-<?php echo base_url(); ?>home/columns">Gallery 3 Column Grid</a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="gallery-four-<?php echo base_url(); ?>home/columns">Gallery 4 Column Grid</a></li>
                                            <li><a class="dropdown-item nav-link nav_item" href="gallery-masonry-three-<?php echo base_url(); ?>home/columns">Gallery 3 Column Masonry</a></li> 
                                            <li><a class="dropdown-item nav-link nav_item active" href="gallery-masonry-four-<?php echo base_url(); ?>home/columns">Gallery 4 Column Masonry</a></li> 
                                        </ul>
                                    </div>
                                </li>
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>home/faq">Faq</a></li>
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>home/404">404 Page</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul> 
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>home/courses">Courses</a></li> 
                                <li><a class="dropdown-item nav-link nav_item" href="course-<?php echo base_url(); ?>home/detail">Course Detail</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul> 
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>home/event">Event</a></li> 
                                <li><a class="dropdown-item nav-link nav_item" href="event-<?php echo base_url(); ?>home/detail">Event Detail</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul> 
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>home/teacher">Teacher</a></li> 
                                <li><a class="dropdown-item nav-link nav_item" href="teacher-<?php echo base_url(); ?>home/detail">Teacher Detail</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul> 
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>home/blog">Blog</a></li> 
                                <li><a class="dropdown-item nav-link nav_item" href="blog-<?php echo base_url(); ?>home/detail">Blog Detail</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-8 mb-4 mb-lg-0">
                	<div class="footer_logo">
                    	<a href="<?php echo base_url(); ?>home/index"><img alt="logo" src="assets/images/footer_logo.png"></a>
                    </div>
