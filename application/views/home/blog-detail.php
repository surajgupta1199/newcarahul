    	...
    	<div class="row">
        	<div class="col-lg-9">
            	<div class="single_post">
                    <div class="blog_img">
                        <a href="#">
                            <img src="<?php echo base_url(); ?>assets/images/blog_img1.jpg" alt="blog_img1">
                        </a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="blog_post box_shadow1 radius_all_10">
                                    <div class="blog_img radius_ltrt_10">
                                        <a href="#">
                                            <img src="<?php echo base_url(); ?>assets/images/blog_small_img1.jpg" alt="blog_small_img1">
                                            <div class="link_blog">
                            ...
                            <div class="col-md-6">
                                <div class="blog_post box_shadow1 radius_all_10">
                                    <div class="blog_img radius_ltrt_10">
                                        <a href="#">
                                            <img src="<?php echo base_url(); ?>assets/images/blog_small_img2.jpg" alt="blog_small_img2">
                                            <div class="link_blog">
                                                <span class="ripple"><i class="fa fa-link"></i></span>
                                            </div>
                                        </a>
                    ...
                    <div class="comment-area">
                        ...
                        <ul class="list_none comment_list">
                            ...
                            <li class="comment_info reply">
                                <div class="d-flex">
                                    <div class="user_img">
                                        <img class="radius_all_5" src="<?php echo base_url(); ?>assets/images/client_img3.jpg" alt="client_img3">
                                    </div>
                                    <div class="comment_content">
                                        <div class="d-flex">
                                            <div class="meta_data">
                            ...
                            <li class="comment_info">
                                <div class="d-flex">
                                    <div class="user_img">
                                        <img class="radius_all_5" src="<?php echo base_url(); ?>assets/images/client_img2.jpg" alt="client_img2">
                                    </div>
                                    <div class="comment_content">
                                        <div class="d-flex">
                                            <div class="meta_data">
                        ...
                        <ul class="recent_post border_bottom_dash list_none">
                            <li>
                                <div class="post_footer">
                                    <div class="post_img">
                                        <a href="#"><img src="<?php echo base_url(); ?>assets/images/letest_post1.jpg" alt="letest_post1"></a>
                                    </div>
                            ...
                            <li>
                                <div class="post_footer">
                                    <div class="post_img">
                                        <a href="#"><img src="<?php echo base_url(); ?>assets/images/letest_post2.jpg" alt="letest_post1"></a>
                                    </div>
                                    <div class="post_content">
                                        <h6><a href="#">Lorem ipsum dolor sit amet, consectetur</a></h6>
                                        <span class="post_date">April 14, 2018</span>
                            ...
                            <li>
                                <div class="post_footer">
                                    <div class="post_img">
                                        <a href="#"><img src="<?php echo base_url(); ?>assets/images/letest_post3.jpg" alt="letest_post1"></a>
                                    </div>
                                    <div class="post_content">
                                        <h6><a href="#">Lorem ipsum dolor sit amet, consectetur</a></h6>
                                        <span class="post_date">April 14, 2018</span>
