                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="signup" role="tabpanel">
                                    ...
                                    <form id='sign_up_form' class="login">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" required="" type="password" id='student_password' name="student_password" placeholder="Password (Min 6 Character)">
                                        </div>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul> 
                                ...
                                <li><a class="dropdown-item nav-link nav_item" href="<?php echo base_url(); ?>student/profile/transaction">Transaction</a></li>
    ...
    $('document').ready(function(){
        ...
        $('#sign_up_form').submit(function(e){
            ...
            if(password.length < 6){
                swal('error','Password has to be atleast 6 Characters','error');
                return false;
            }
